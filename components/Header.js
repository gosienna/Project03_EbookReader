...
export const Header = ({ onBack, onResetCredentials }) => {
  return React.createElement(
    "header",
    { className: "relative z-[100] bg-gray-800 shadow-xl p-4 flex items-center justify-between border-b border-gray-700/50" },
    React.createElement(
      "div",
    ...
    React.createElement(
      ...
      onResetCredentials &&
        React.createElement(
          ...
          React.createElement(CogIcon, { className: "h-6 w-6 pointer-events-none" })
        )
    )
  );
};